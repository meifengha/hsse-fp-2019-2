...
class App private
{
  ...
  new JFrame
  {
    ...
    setContentPane(new Panel
    {
      ...
      atNewLine(button("C")).beside(button("/")).beside(button("*")).beside(button("%")).beside(button("sin")).beside(button("x^2"))
      atNewLine(button("7")).beside(button("8")).beside(button("9")).beside(button("+")).beside(button("cos")).beside(button("x^3"))
      atNewLine(button("4")).beside(button("5")).beside(button("6")).beside(button("-")).beside(button("tan")).beside(button("x^y"))
      atNewLine(button("1")).beside(button("2")).beside(button("3")).beside(button("=")).beside(button("Pi")).beside(button("log"))
      atNewLineWithColumnSpan(button("0"), 3).beside(button(".")).beside(button("sqrt(x)")).beside(button("1/x"))
    })
    setResizable(false)
    pack()
  }.setVisible(true)
