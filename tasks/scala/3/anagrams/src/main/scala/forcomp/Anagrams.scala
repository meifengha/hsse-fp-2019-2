...
object Anagrams {
  ...
  def sentenceOccurrences(s: Sentence): Occurrences = 
  {
    def sentenceOccurrenceIter(s: Sentence): Occurrences =
    {
      ...
      {
        sentenceOccurrences(s.head) ++ sentenceOccurrenceIter(s.tail)
      }
    }
  ...
  {
    def subFunc(occurrences: Occurrences) : List[Sentence] = occurrences match
    {
      case _ =>
      {
        for
    ...
    subFunc(sentenceAnagrams(sentence));
  }
